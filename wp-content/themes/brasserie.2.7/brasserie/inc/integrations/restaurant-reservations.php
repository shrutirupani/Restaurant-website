 ...
 * @package    brasserie
 */
if ( !function_exists( 'brasserie_move_message_field' ) ) {
	/**
	 * Move the message field into its own fieldset
	 *
	 * @since 0.1
	 */
	function brasserie_move_message_field( $fields, $request ) {
	...
	add_filter( 'rtb_booking_form_fields', 'brasserie_move_message_field', 10, 2 );
}
