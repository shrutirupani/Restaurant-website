...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footer_container">
			<?php
				if ( is_active_sidebar( 'single_footer' ) ) {
					echo '<div class="single-footer-widget-area">';
						dynamic_sidebar( 'single_footer' );
					echo '</div>';
				}
			?>
		...
		<div class="site-info">
			...
			<?php _e('Brasserie WordPress Restaurant Theme','brasserie'); ?></a>
